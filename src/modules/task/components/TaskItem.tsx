...
export const TaskItem: FC<Props> = ({ task, index, onDragStart, onDragOver, onDrop }) => {
    ...
    >
      <div className='flex'>
        <div className='flex flex-1 gap-2 items-center overflow-hidden'>
          ...
          >
            <input
              className={`bg-transparent w-full resize-none text-xs md:text-lg text-slate-400 font-medium focus:outline-none cursor-pointer transition-all duration-200 ${
                task.completed && 'line-through opacity-25'
              }`}
