  ...
  return (
    <div className='bg-secondary p-3 text-primary font-bold flex justify-center gap-5 rounded'>
      <button
        ...
        className={`font-bold shadow hover:brightness-200 ${
          filter.all && 'border-b-2 border-b-blue-500 text-blue-500 pointer-events-none'
        }`}
      >
        All
      </button>
      <button
        ...
        className={`font-bold shadow hover:brightness-200 ${
          !filter.all &&
          !filter.value &&
          'border-b-2 border-b-blue-500 text-blue-500 pointer-events-none'
        }`}
      >
        Active
      </button>
