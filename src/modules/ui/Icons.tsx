...
export const Cross = () => {
  return (
    <img
      className='w-3 h-3 hover:brightness-200'
...
export const Completed = () => {
  return (
    <picture className='bg-gradient-to-r from-blue-300 to-violet-500 w-full h-full rounded-full flex justify-center items-center'>
      <img
        className='w-2 h-2 lg:w-3 lg:h-3 object-contain '
...
export const UploadPhoto = () => {
  return (
    <picture className='flex flex-col items-center'>
      <img
        className='w-8 h-8 md:w-10 md:h-10 object-contain hover:brightness-150 transition-all duration-300'
        src='/img/gallery.png'
        alt='Upload Icon'
      />
