  ...
  return (
    <AuthLayout title='Sign Up'>
      ...
      >
        <div className='text-violet-400 flex flex-col gap-2'>
          ...
          <input
            ...
            className={`bg-primary p-2 text-sm rounded text-white ${
              formik.errors.userName && 'border-2 border-red-400 focus:outline-red-400'
            }`}
        ...
        <button
          disabled={checking}
          className='bg-violet-500 p-2 text-white font-medium rounded hover:brightness-105 transition-all duration-200 mt-2 shadow-sm shadow-violet-400'
        >
          Sign up!
        </button>
